...
//     const coursesElement = coursesArray[i];
//     let div = document.createElement('div');
//     let title = document.createElement('div');
//     let monthDuration = document.createElement('div');
//     let hourDuration = document.createElement('div');
//     let modules = document.createElement('div');
//     for (const item in coursesElement.modules) {
//         const innerBlock = document.createElement('li');
//         innerBlock.innerHTML = coursesElement.modules[item];
//         modules.appendChild(innerBlock);
//     }
...
// htmlDiv.style.background = 'pink';
// htmlDiv.style.color = 'grey';
// htmlDiv.style.fontSize = '50px';
// document.body.append(htmlDiv);
// let cloneHtmlDiv = htmlDiv.cloneNode();
// document.body.append(cloneHtmlDiv)
